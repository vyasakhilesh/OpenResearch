...
from tasks.eventSeries import preprocessing_core_openresearch_eventSeries, create_openresearch_eventSeries, deduplicate_openresearch_eventSeries
import os
...
def openresearch_eventSeries(api_url: str,
    ...
    create_openresearch_eventSeries(api_url,
                                    username,
                                    password,
                                    core_all_details_path,
                                    template_name=template_name,
...
if __name__ == "__main__":
    ...
    preprocessing_core_openresearch_eventSeries(API,
                                   USER,
                                   PASS,
                                   core_all_details_path,
